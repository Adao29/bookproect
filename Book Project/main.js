...
function avancar (){
    if (pagina == 0){
        ...
        document.querySelector('#imagens img').src="O macaco, o cachorro e a onça.png"
        pagina = 1;
    }
    else{
        if (pagina == 1){
            ...
            document.querySelector('#imagens img').src="ZqeCO-wSQf6UrX2RZUd-XA.png"
            pagina = 2;
        }
        else{
            if (pagina == 2){
                ...
                document.querySelector('#imagens img').src="5-V2wDzFRqaWq2BYIEQJeA.png"
                pagina = 3;
            }
            else{
                if (pagina == 3){
                    ...
                    document.querySelector('#imagens img').src="RQSwc_BjTMO_gBd9rNLe6w.png"
                    pagina = 4;
                }
                else{
                    if (pagina == 4){
                        document.querySelector('#texto p').innerHTML="A onça, furiosa, foi atrás novamente do macaco.";
                        document.querySelector('#imagens img').src="cd896ca1-ebeb-4500-a05c-54d59a4e08ab.png"
                        pagina = 5;
                    }
                    else{
                        if (pagina == 5){
                            ...
                            document.querySelector('#imagens img').src="ac2171b4-f45b-4a36-a9db-e0c1e11304cc.png"
                            pagina = 6;
                        }
                        else{
                            if (pagina == 6){
                                ...
                                document.querySelector('#imagens img').src="2a221269-b946-4baa-bb90-026b30b3f61b.png"
                                pagina = 7;
                            }
                            else{
                                if (pagina == 7){
                                    document.querySelector('#texto p').innerHTML="";
                                    document.querySelector('#imagens img').src="O macaco, o cachorro e a onça (1).png"
                                }
                                else{
